...
Use this [LA01WriteUp.Rmd](./LA01WriteUp.Rmd) file to answer the questions below.  If a question requires code, put the code in the code chunk (under **Code**). When complete, save submit the completed "LA01WriteUp.Rmd" to Canvas. 
