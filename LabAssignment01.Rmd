...
Using the same data set, we want to understand what drives units sold per week, while controlling for any seasonality that exists.  Therefore, run a linear regression model with ad campaign, end cap, price, and month as our predictor variables. Answer the following questions, providing output where needed. 
...
See [this section](https://jdmeyer73.github.io/MKT4320RTut/linear-regression.html#continuous-iv-at-levels-of-factor-iv) of the R Tutorial for help on producing the margin plot.
